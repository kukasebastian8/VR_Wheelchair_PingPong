...
/// <summary>
/// Inheriting from XRBaseInteractable, VRWC_WheelInteractable provides unique behavior to handle dynamic grab point, braking, and auto-deselection.
/// </summary>
public class VRWC_WheelInteractable : UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable
{
    ...
    protected override void OnSelectEntered(SelectEnterEventArgs eventArgs)
    {
        ...
        UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor interactor = (UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor)eventArgs.interactorObject;
    ...
    void SpawnGrabPoint(UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor interactor)
    {
        ...
        if (grabPoint)
        {
            interactionManager.CancelInteractableSelection(grabPoint.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable>() as IXRSelectInteractable);
        }
        ...
        interactionManager.SelectEnter(interactor as IXRSelectInteractor, grabPoint.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable>() as IXRSelectInteractable);
    }
    ...
    IEnumerator MonitorDetachDistance(UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor interactor)
    {
        ...
        while (grabPoint)
        {
            ...
            {
                interactionManager.CancelInteractorSelection(interactor as IXRSelectInteractor);
            }
